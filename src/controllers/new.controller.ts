...
export const getNews: Handler = async (req: Request, res: Response) => {
...
export const getNew: Handler = async (req: Request, res: Response) => {
...
export const createNew: Handler = async (req: Request, res: Response) => {
...
export const updateNew: Handler = async (req: Request, res: Response) => {
...
export const deleteNew: Handler = async (req: Request, res: Response) => {
