...
export const getGithubs: Handler = async (req: Request, res: Response) => {
...
export const getGithub: Handler = async (req: Request, res: Response) => {
...
export const createGithub: Handler = async (req: Request, res: Response) => {
...
export const updateGithub: Handler = async (req: Request, res: Response) => {
...
export const deleteGithub: Handler = async (req: Request, res: Response) => {
